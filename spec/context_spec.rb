  ...
  describe Context do
    ...
    describe "#feature_active?" do
      ...
      it "should return true when active" do
        active_feature.should_receive(:active_for?).with(context, true).and_return(true)
        context.feature_active?(:active_feature).should be_true
      end

      it "should return true when active" do
        inactive_feature.should_receive(:active_for?).with(context, true).and_return(false)
